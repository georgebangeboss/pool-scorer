...
public class RestartGameDialog extends AppCompatDialogFragment {
    private DBViewModel mViewModel;

    public RestartGameDialog(DBViewModel dbViewModel) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(v)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //TODO delete all events,new balls,clear players
                        //TODO delete the game from DB
